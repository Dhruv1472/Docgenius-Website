            ...
            <div className="pt-4 border-t border-background/20">
              ...
              <a href="https://mvclouds.com/" target="_blank" rel="noopener noreferrer" aria-label="MV Clouds" className="block mb-4">
               ...
               <div className="flex items-center gap-3">
                  <a href="https://wa.me/919558019600?text=Hello%2C%20I%E2%80%99m%20interested%20in%20Docgenius.%20Can%20we%20discuss%20further%3F" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="h-10 w-10 rounded-full bg-white/5 flex items-center justify-center text-background/70 hover:text-background">
                    {/* WhatsApp SVG */}
                  ...
                  <a href="https://www.linkedin.com/showcase/docgeniusai/about/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="h-10 w-10 rounded-full bg-white/5 flex items-center justify-center text-background/70 hover:text-background">
                    {/* LinkedIn SVG */}
                  ...
                  <a href="https://www.instagram.com/docgeniusai/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="h-10 w-10 rounded-full bg-white/5 flex items-center justify-center text-background/70 hover:text-background">
                    {/* Instagram SVG */}
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a href="https://x.com/Docgenius_AI" target="_blank" rel="noopener noreferrer" aria-label="X" className="h-10 w-10 rounded-full bg-white/5 flex items-center justify-center text-background/70 hover:text-background">
                    {/* X (Twitter) SVG */}
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a href="https://www.youtube.com/@Doc-Genius" target="_blank" rel="noopener noreferrer" aria-label="X" className="h-10 w-10 rounded-full bg-white/5 flex items-center justify-center text-background/70 hover:text-background">
                    {/* Youtube SVG */}
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" height="24" width="24" fill="currentColor">
                      <path d="M23.498 6.186a3.016 3.016 0 0 0 -2.122 -2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0 -9.377 0.505A3.017 3.017 0 0 0 0.502 6.186C0 8.07 0 12 0 12s0 3.93 0.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871 0.505 9.376 0.505 9.376 0.505s7.505 0 9.377 -0.505a3.015 3.015 0 0 0 2.122 -2.136C24 15.93 24 12 24 12s0 -3.93 -0.502 -5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" stroke-width="1"></path>
                    </svg>
                  </a>
                </div>
            </div>
          ...
          <div>
            ...
            <p className="text-background/70 text-sm mb-4">
              ...
              <a
                ...
                className="text-background/70 hover:text-background underline block mt-2"
              >
            ...
            <div className="text-background/70 text-sm mb-6">
              <div className="text-background/70 hover:text-background flex">
                ...
                <div className="inline-block">
                  <div className="mb-4"><strong>India (Headquarter)</strong> :  D-404, The First Synthesis, B/H Keshavbaug Party Plot, Ahmedabad, Gujarat - 380015</div>
