            ...
            <div className="pt-4 border-t border-background/20">
              ...
              <a href="https://mvclouds.com/" target="_blank" rel="noopener noreferrer" aria-label="MV Clouds" className="block mb-4">
               ...
               <div className="flex items-center gap-3">
                  <a href="https://wa.me/919558019600?text=Hello%2C%20I%E2%80%99m%20intersted%20in%20Docgenius.%20Can%20we%20discuss%20further%3F" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="h-10 w-10 rounded-full bg-white/5 flex items-center justify-center text-background/70 hover:text-background">
                    {/* WhatsApp SVG */}
